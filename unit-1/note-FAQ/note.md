...
## 1. Should I buy a new laptop/workstation?
...
If you do not have a reasonably modern laptop, you will need one almost immediately. Tune in to a dedicated channel on our Slack workspace as soon as possible if you need advice. See question 11.

## 2. What is Slack? How do I sign up?
...
- [SETU Cert AI/ML 2026 Slack](https://join.slack.com/t/setu-aiml-sw-eng/shared_invite/zt-4849twi0j-NcEQQz2aGrKqVXgaSGUg~A)
...
## 3. What is Github? How do I sign up?
...
## 4. What is Moodle? How do I sign up?
...
## 5. Do I have to attend Induction?

The course team expect that all students starting the programme in 2026 will attend this important workshop, to take place **on Friday 4th Sept**. 

You will find the agenda [here](https://tutors.dev/course/setu-cert-comp-sci-2026-workshop-1). If for any reason you cannot attend, please make immediate contact with the course team.

## 6. What should I have done in advance of attending the Induction?
...
- Sign up for the programme AI/ML 2026 Slack Workspace
- Sign up for a Github account
- Configure your workstation/laptop as detailed in Question 10 below

## 7. Where is the course material for the programme?

All course material will be published on [this site](https://tutors.dev/course/setu-cert-sw-eng-2026). Please bookmark this now.

## 8. Where do I learn about the features of the programme website?

This programme web site is designed to be 'discoverable' - i.e. navigating & experimenting with the site should be sufficient to master it. We will review all web resources during Induction. In advance, you might find [this introduction useful.](https://tutors.dev/talk/setu-hdip-comp-sci-2025-workshop-1-3/unit-1/talk-2-course-webs)

## 9. Is there a calendar/timetable for the programme?

Yes, you can find it [here](https://tutors.dev/course/setu-sw-eng-2026-schedules).

## 10. Where are the workstation configuration instructions?

Each module may have differing requirements. These are specific instruction for the first 2 modules:

- [Web App Dev](https://tutors.dev/course/setu-sw-eng-2026-web-app-dev)
- [DevOps](https://tutors.dev/course/setu-sw-eng-2026-dev-ops)


## 11. What should I do if I am having a problem configuring my laptop?

Seek help on Slack, there will be a channel for PC & Laptop specs. Also, seek help on the specific programming and web development channels in Slack. 

## 12. What is "Life etc...?"    

This [short video](https://youtu.be/7AhEa-w1ZPU) provides good introduction.

## 13. What will we do at Induction?

Full agenda and talks are showing  [here](https://tutors.dev/course/setu-cert-comp-sci-2026-workshop-1). Keep an eye for more updates as the date approaches.
